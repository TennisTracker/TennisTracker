...
class NewMatch : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.FirstServeMissed.setOnClickListener{
            newMatchViewModel.firstServesMissed +=1
        }

        binding.SecondServeMissed.setOnClickListener{
            //CREATE WHOEVER IS SERVING AND MAKE THAT P1 OR P2
        ...
        binding.ReturnMissed.setOnClickListener{
            newMatchViewModel.totalpoints += 1
  ...
  */
    ...
    public fun pointScored(i:Int){
        if (i == 1){
            binding.scoreP1.text = gameScores[newMatchViewModel.P1index].toString()
            newMatchViewModel.P1index += 1
        }
        else if (i==2){
            binding.scoreP2.text = gameScores[newMatchViewModel.P2index].toString()
            newMatchViewModel.P2index += 1
        }
    ...
    public fun gameScored(i:Int){
        if (i==1){
            ...
            binding.gameP1.text = setScores[newMatchViewModel.P1gameIndex].toString()
            binding.scoreP2.text = gameScores[newMatchViewModel.P2index].toString()
            newMatchViewModel.P2index +=1
            binding.scoreP1.text = gameScores[newMatchViewModel.P1index].toString()
            newMatchViewModel.P1index+=1
            ...
            binding.gameP2.text = setScores[newMatchViewModel.P2gameIndex].toString()
            binding.scoreP1.text = gameScores[newMatchViewModel.P1index].toString()
            newMatchViewModel.P1index +=1
            binding.scoreP2.text = gameScores[newMatchViewModel.P2index].toString()
            newMatchViewModel.P2index+=1
